...
#   embedded systems, setting up whole-module optimization and target configuration.
#
...
#   determines the appropriate Swift target triple for cross-compilation.
#   The target triple is set in the SWIFT_TARGET variable in the parent scope.
#
#   **Supported Architectures:**
#
#   * **ARM Cortex-M Series:**
...
#     - Cortex-M4/M7: thumbv7em-none-eabi[hf] (hf = hardware floating point)
#     - Cortex-M23/M33/M35P/M55: thumbv8m.main-none-eabi[hf]
#
#   * **ARM 64-bit:** aarch64-none-elf
#
#   * **RISC-V:** riscv32/riscv64-none-none-eabi
#
#   The function automatically detects floating-point ABI configuration
#   and selects the appropriate hard-float variant when available.
#
function(_swift_map_target)
  # ARM Cortex-M family processors
  if(CONFIG_CPU_CORTEX_M)

    # Cortex-M0, M0+, M1 - ARMv6-M architecture
    # These are the most basic Cortex-M cores with Thumb instruction set only
    ...
    # Adds more advanced Thumb-2 instructions but no floating-point unit
    elseif(CONFIG_CPU_CORTEX_M3)
      set(SWIFT_TARGET "thumbv7m-none-eabi" PARENT_SCOPE)

    # Cortex-M4, M7 - ARMv7E-M architecture with optional FPU
    # These cores support DSP instructions and optional floating-point
    ...
    # Cortex-M23, M33, M35P, M55 - ARMv8-M architecture
    # Latest generation with TrustZone security extensions and optional FPU
    elseif(CONFIG_CPU_CORTEX_M23 OR CONFIG_CPU_CORTEX_M33 OR CONFIG_CPU_CORTEX_M35P OR CONFIG_CPU_CORTEX_M55)
      ...
      # Unsupported Cortex-M variant - this should not happen with current Zephyr
  ...
  elseif(CONFIG_RISCV)
    ...
    # Architecture not yet supported - extend this function for new architectures
    message(FATAL_ERROR "Swift: Architecture not supported. Please add support for this target architecture.")
  endif()
endfunction()
